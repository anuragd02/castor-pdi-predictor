...
/* ════════════════════════════════════════
   PANEL — use Streamlit's column as card
   ════════════════════════════════════════ */
...
/* ════════════════════════════════════════
   NUMBER INPUTS — minimal, clean, flat
   ════════════════════════════════════════ */

/* Kill every wrapper border/shadow Streamlit adds */
...
div[data-testid="stNumberInput"] input {
    ...
    /* crucial: keep a uniform border on all 4 sides */
    border-right: 1.5px solid #b8d8b8 !important;
}
...
/* Step buttons — sit OUTSIDE the text field visually */
